...
public class Joueur2 extends Joueur {
	...
	public Joueur2(int id, int x, int y, Equipe equipe) {
		super(id, x, y, equipe);
	...
	protected boolean isPositiondeTir(){
		return (x_tactique < playMatch.min_x + (playMatch.mid_x/2) && getCurentMove().getY_current() >  playMatch.min_y +(playMatch.mid_y/2) && getCurentMove().getY_current() < playMatch.max_y - (playMatch.mid_y/2) );
	}
	
	protected void tirauBut() {//TODO
